                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <?php
                      $queq="SELECT id from job ORDER BY id" ;
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <?php
                      $queqto="SELECT id from hr ORDER BY id" ;
                      $runtto=mysqli_query($conn,$queqto);
                      $hr_row=mysqli_num_rows($runtto);
                      echo '<span class="h2 font-weight-bold mb-0">'.$hr_row.'</span>';
