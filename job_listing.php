   ...
   <body>
    ...
    <main>
        ...
        <select name="category">
            ...
            <option value="Civil" <?php if($category == 'Civil') echo 'selected'; ?>>Civil</option>
            <option value="Computer & IT" <?php if($category == 'Computer & IT') echo 'selected'; ?>>Computer & IT</option>
            <option value="Tally" <?php if($category == 'Tally') echo 'selected'; ?>>Tally</option>
        ...
        <select name="location">
            ...
            <option value="Kolhapur" <?php if($location == 'Kolhapur') echo 'selected'; ?>>Kolhapur</option>
            <option value="Bangalore" <?php if($location == 'Bangalore') echo 'selected'; ?>>Bangalore</option>
        </select>
    </div>
    <button type="submit" class="btn" style="margin-top:10px; margin-left:40px;">Filter</button>
</form>
    ...
    <div class="job-items">
        <div class="company-img" style="width:85px; height:85px; border-style: groove; border-color: #0056b3; border-width: thin;">
            <?php if (isset($row['img'])): ?>
                <img src="upload/<?= $row['img'] ?>" class="img-fluid" style="height:85x; object-fit: contain;" alt="Product Image">
            <?php else: ?>
        ...
        <div class="job-tittle job-tittle2 mx-5">
            ...
            <ul>
                <li><?= ucfirst($row['title']) ?></li>
                <li><i class="fas fa-map-marker-alt"></i><?= ucfirst($row['loc']) ?></li>
                <li>$<?= ucfirst($row['salary']) ?></li>
            </ul>
        </div>
    </div>
    <div class="items-link items-link2 f-right">
        <a href="job_details.php?id=<?= $row['id'] ?>">View</a>
    </div>
</div>
